...
- **Problem:** İkili sınıflandırma (popularity 0–49 → Düşük, 50–100 → Yüksek)
- **Kaynak:** `notebooks/Spotify_ML_Pipeline_Reorganized_v2.ipynb`
- **Final model:** Random Forest Classifier → `models/best_classifier_rf.pkl`
- **Metrikler:** Accuracy, F1 (weighted/macro), ROC-AUC, confusion matrix — **R²/RMSE kullanma**
- **Eski regresyon pipeline:** Arşiv — `scripts/ARCHIVED_REGRESSION_PIPELINE.md`
