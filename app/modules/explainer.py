"""
Explainer Module — model tahminini açıklama.
⚠️ Mevcut sürüm regresyon (SHAP KernelExplainer) içindir.
Sınıflandırma için TreeExplainer veya permutation_importance kullanılmalı.
Güncel model: Random Forest Classifier (models/best_classifier_rf.pkl)
"""
...
class ExplainerModule:
    ...
    def _get_top_features(self, shap_values, input_values, top_k=15):
